...
var (
	appVersion = "v1.1.0"
	chainIDMap = map[string]int{"ropsten": 3, "rinkeby": 4, "goerli": 5, "kovan": 42, "moonbase": 1287}
	...
	netnameFlag  = flag.String("faucet.name", "moonbase", "Network name to display on the frontend")
